  ...
  <div class="about">
    ...
    <div class="content">
      <div class="information">
        <div class="contact">
          ...
          <div class="contact-details">
            ...
            <a
              ...
              >
              <svg-icon name='twitter' iconStyle="width:50px;height:50px"></svg-icon></a>
            <a
              class="telegram"
              target="_blank"
              ...
              <svg-icon name='telegram' iconStyle="width:50px;height:50px"></svg-icon></a>
            <a
              class="instagram"
              target="_blank"
        ...
        <div id="profile" class="profile markdown-body md">
          <!-- <div class="before">关于本人</div> -->
          <div :id="idName" class="md"></div>
...
const getData = () => {
  getAbout().then((data: any) => {
    ...
    // if (data) {
      ...
      // Vditor.preview(profileDiv, data.Author, {
      //   mode: 'dark',
      //   anchor: 1,
      //   hljs: {
      //     enable: true,
